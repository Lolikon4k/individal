<div class="your-table-container ">
    <div class="section__title my-10 section__title-primogemes">
        <span>Добавление тип оплаты</span>
    </div>
    <form action="/addTypePays" class="my-10" method="POST">
        @csrf
    ...
    <div class="section__title my-10 section__title-primogemes">
        <span>Редактирование типа оплаты</span>
    </div>
            ...
            @foreach ($type_pays as $item)
                <tr class="border-b">
                    ...
                    <td class="text-sm white font-light whitespace-nowrap">
                        <form id="typePaysForm{{ $item->id }}" action="/redactTypePays/{{ $item->id }}"
                    ...
                    <td class="text-sm white font-light whitespace-nowrap">
                        <button type="submit" form="typePaysForm{{ $item->id }}"
